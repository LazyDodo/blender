...
#define FOREACH_COLLECTION_BASE_RECURSIVE_BEGIN(_group, _base)                    \
	for (Base *_base = (Base*)BKE_collection_object_cache_get(_group).first; \
	     _base;                                                              \
	     _base = _base->next)                                                \
	{
...
#define FOREACH_COLLECTION_OBJECT_RECURSIVE_BEGIN(_group, _object)                \
	for (Base *_base = (Base*)BKE_collection_object_cache_get(_group).first; \
	     _base;                                                              \
	     _base = _base->next)                                                \
	{                                                                        \
