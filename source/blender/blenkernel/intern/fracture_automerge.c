...
void BKE_fracture_automerge_refresh(FractureModifierData* fmd)
{
    ...
    else if (fmd->visible_mesh)
    {
        ...
        BM_mesh_bm_to_me(NULL, fmd->visible_mesh, fdm, &bmt);
        BKE_fracture_shared_vert_groups(fmd, fdm, &fmd->shared_verts);
