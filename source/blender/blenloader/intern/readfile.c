...
{
	FileData *fd = (FileData*)(*bh);
	return link_named_part_ex(mainl, fd, NULL, NULL, idcode, name, NULL, flag, bmain, scene, view_layer, v3d);
}
 ...
 * \param flag: Options for linking, used for instantiating.
 * \param bmain: The current file's Main database.
 * \param scene: The scene in which to instantiate objects/groups (if NULL, no instantiation is done).
 * \param view_layer: The active ViewLayer (where objects & groups would be instantiated, can be NULL).
 * \param v3d: The active View3D, used in case of local view...
 * \return the linked ID when found.
 */
        ...
        Main *bmain, Scene *scene, ViewLayer *view_layer, const View3D *v3d)
{
	...
	return link_named_part_ex(
	            mainl, fd, aet, root, idcode, name, uuid, flag, bmain, scene, view_layer, v3d);
}
