...
def km_hair(params):
    ...
    items.extend([
        *_template_items_select_actions(params, "hair.select_all"),
        ("hair.select_more", {"type": 'NUMPAD_PLUS', "value": 'PRESS', "ctrl": True}, None),
        ("hair.select_less", {"type": 'NUMPAD_MINUS', "value": 'PRESS', "ctrl": True}, None),
        ("hair.select_linked", {"type": 'L', "value": 'PRESS'},
         {"properties": [("deselect", False)]}),
        ("hair.select_linked", {"type": 'L', "value": 'PRESS', "shift": True},
         {"properties": [("deselect", True)]}),
        ("hair.delete", {"type": 'X', "value": 'PRESS'}, None),
        ("hair.delete", {"type": 'DEL', "value": 'PRESS'}, None),
        ("hair.reveal", {"type": 'H', "value": 'PRESS', "alt": True}, None),
        ("hair.hide", {"type": 'H', "value": 'PRESS'},
         {"properties": [("unselected", False)]}),
